...
            terrainEnabled,
            terrainExaggeration,
            map.current.queryTerrainElevation?.bind(map.current)
          );
...
when I enbale terrain it stalls, I think it should not rerender the whole function on terrain ebaled, check for efficiency