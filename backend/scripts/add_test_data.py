...
print(
    f"🔑 Service key loaded: {bool(settings.SUPABASE_SERVICE_KEY and len(settings.SUPABASE_SERVICE_KEY) > 20)}"
)
print(
    f"🔑 Service key prefix: {settings.SUPABASE_SERVICE_KEY[:20] if settings.SUPABASE_SERVICE_KEY else 'MISSING'}..."
)
