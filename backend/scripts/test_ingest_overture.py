...
def ingest_buildings(bbox: tuple[float, float, float, float], limit: int = 1000):
    ...
    print(f"⏳ This may take 1-2 minutes - scanning S3 Parquet files...")
...
def main():
    ...
    parser.add_argument('--bbox', type=str, default='11.4,48.1,11.7,48.2',
                       help='Bounding box as min_lon,min_lat,max_lon,max_lat (default: Munich area)')
    parser.add_argument('--limit', type=int, default=1000,
                       help='Max features per layer (default: 1000)')
    parser.add_argument('--layers', type=str, default='buildings,roads,landuse',
