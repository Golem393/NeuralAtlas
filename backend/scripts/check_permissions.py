...
try:
    ...
    test_wkt = "MULTIPOLYGON(((11.55 48.13, 11.551 48.13, 11.551 48.131, 11.55 48.131, 11.55 48.13)))"
    result = supabase.rpc('insert_building', {
    ...
    print(f"✅ Can call insert_building function")
except Exception as e:
