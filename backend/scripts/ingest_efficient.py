...
def ingest_from_local(limit=1000):
    ...
    print("🚀 Reading from local extract (FAST)...")
...
def main():
    ...
    parser.add_argument(
        "--download", action="store_true", help="Download Munich extract first (one-time, slow)"
    )
    parser.add_argument(
        "--limit", type=int, default=500, help="Max buildings to insert (default: 500)"
    )
